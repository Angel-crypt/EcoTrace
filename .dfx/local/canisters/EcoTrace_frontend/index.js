...
import { idlFactory } from './EcoTrace_frontend.did.js';
export { idlFactory } from './EcoTrace_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ECOTRACE_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./EcoTrace_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the EcoTrace_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./EcoTrace_frontend.did.js")._SERVICE>}
 */
export const EcoTrace_frontend = createActor(canisterId);
