...
import { idlFactory } from './EcoTrace_backend.did.js';
export { idlFactory } from './EcoTrace_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ECOTRACE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./EcoTrace_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the EcoTrace_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./EcoTrace_backend.did.js")._SERVICE>}
 */
export const EcoTrace_backend = createActor(canisterId);
